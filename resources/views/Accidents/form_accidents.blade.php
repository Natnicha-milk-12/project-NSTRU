...
@section('content')
    ...
    <div class="card d-flex justify-content-center mx-auto  ">
        <div class="card-body">
            ...
            <hr>
            <form action="{{ url('form_accidents') }}" method="POST" enctype="multipart/form-data">
                <div class="row mb-4 needs-validation">
                    ...
                    <div class="col-sm-12 py-2">
                        <div class="form-outline">
                            ...
                            <textarea class="form-control" name="effect" id="exampleFormControlTextarea1" rows="3" required=""></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12 py-2">
                        <div class="form-outline">
                            <label class="form-label" for="form6Example2">วิธีการแก้ไขปัญหา</label>
                            <textarea class="form-control" name="solutions" id="exampleFormControlTextarea1" rows="5" required=""></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12 py-2">
                        <div class="form-outline">
                            <label class="form-label" for="form6Example2">ผู้ติดตาม</label>
                            <select class="selectpicker" multiple data-live-search="true" name="follower_name">
